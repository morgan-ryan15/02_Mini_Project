...
for(i in length(college_for_majors)) {
  url <- str_c("https://www.niche.com/colleges/", college_for_majors[i], "/majors/")
  Sys.sleep(0.5) 
  one_college <- GET(url)
  details <- content(one_college, "parse")
  college_tibble[i,1] <- details$College_name
  college_tibble[i,2] <- details$Major
}
